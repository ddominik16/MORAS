class Parser:
    def __init__(self):
        ...
        self._defined_labels = set()  # 1b zadaca
        self._referenced_labels = set() # 1b zadaca
    ...
    def parseFile(self, filename):
        ...
        self._validate_labels() # 1b zadaca
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            if len(l) == 3 and l[2].isdigit(): # 1a ZADATAK
            ...
            if l[0] == "label" and len(l) == 2:
                self._defined_labels.add(l[1]) # 1b zadaca
                return "//" + " ".join(l) + "\n" + self._label(l[1], n)
            elif l[0] == "goto" and len(l) == 2:
                self.referenced_labels.add(l[1]) # 1b zadaca
                return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
    ...
    def _validate_labels(self):  # 1b zadaca
        undefined_labels = self._referenced_labels - self._defined_labels
        for label in undefined_labels:
            Parser._error("Parser", -1, f"Undefined label: '{label}'")
            self._flag = False
